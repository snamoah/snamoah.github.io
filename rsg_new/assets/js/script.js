...
$(function() {
  $('button').click(function() {
    ...
    if(generated_eits.length) {

      $.each(generated_eits, function(i, item) {
        $(".results").append("<div class='col-md-4'><img src='assets/images/" + this.image + "' /></div>");
      });
    } else {
      $(".results").append("<div style='margin-left: auto; margin-right: auto;  display: block;'><img src='assets/images/" + generated_eits.image + "' /></div>");
    }
  });
});
